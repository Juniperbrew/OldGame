	...
	public ChatClient () {
		...
		client.addListener(new Listener() {
			public void connected (Connection connection) {
				...
				registerName.position = new Vector3(0,0,0);
			...
			public void received (Connection connection, Object object) {
				...
				if (object instanceof UpdateClients) {
					...
					chatFrame.setNames(updateClients.names);
					return;
				}
				...
				if (object instanceof ChatMessage) {
					...
					chatFrame.addMessage(chatMessage.name + ": " + chatMessage.text);
					return;
				}
			}
		...
		public ChatFrame (String host) {
			...
			}
			{
				...
				contentPane.add(panel, "chat");
				{
					...
					panel.add(topPanel);
					{
						topPanel.add(new JScrollPane(messageList = new JList()), BorderLayout.CENTER);
						messageList.setModel(new DefaultListModel());
					}
					{
						topPanel.add(new JScrollPane(nameList = new JList()), BorderLayout.LINE_END);
